 ...
 */
export function DynamicHeader(largeHeaderElement, backgroundCanvasElement, color) {
    let width, height, largeHeader, canvas, ctx, points, target, defaultColor, animateHeader = true;

    init(largeHeaderElement, backgroundCanvasElement, color);

    // Main
    function init(largeHeaderElement, backgroundCanvasElement, color) {
      initHeader(largeHeaderElement, backgroundCanvasElement, color);
      initAnimation();
      addListeners();
    }

    function initHeader(largeHeaderElement, backgroundCanvasElement, color) {
